...
class Battle:
    ...
    def status_effect(self, character, status_name):
        ...
        # Ampy's buffs/debuffs
        elif status_name == "Eternal Focus":
            if not self.buff_check(character, status_name):
                ...
                elif character.name == "Kiko":
                    print(f"Usually Ampy will reject it but since he loves {colored_name(character.name)} he gets the buff anyways")
                    character.charged = 2.5
                    character.status[status_name] = "infinite"
                else:
    ...
    def perform_skill(self, character, skill_num, enemy):
        ...
        if skill.isHeal:
            ...
            if character.charged > 1:
                ...
                character.charged = 1
                del character.status["Eternal Focus"]
